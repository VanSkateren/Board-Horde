...
namespace Animancer.Examples
{
    ...
    /// other examples.
    /// </remarks>
    [AddComponentMenu("Animancer/Examples/Interruptable Creature")]
    [HelpURL(AnimancerPlayable.APIDocumentationURL + ".Examples/InterruptableCreature")]
    public sealed class InterruptableCreature : MonoBehaviour, IAnimancerClipSource
    {
        /************************************************************************************************************************/
        ...
        public StateMachine<InterruptableCreatureState> StateMachine { get; private set; }
        ...
        private void Awake()
        {
            ...
            StateMachine = new StateMachine<InterruptableCreatureState>(_Idle);
        }
        ...
        /// </summary>
        public void TrySetState(InterruptableCreatureState state)
        {
        ...
        private void AfterInspectorGUI()
        {
            ...
            {
                GUI.enabled = false;
                UnityEditor.EditorGUILayout.ObjectField("Current State", StateMachine.CurrentState, typeof(InterruptableCreatureState), true);
            }
        }
